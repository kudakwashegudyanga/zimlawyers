...
import { Send, Bot, User, LogOut, FileText, Briefcase } from 'lucide-react';
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden sm:flex items-center space-x-8">
                <div className="flex items-center">
                  ...
                  <h1 className="ml-2 text-xl font-bold text-gray-900">AI Assistant</h1>
                </div>
                <button
          ...
          <div className="bg-white rounded-lg shadow-sm">
            <div className="h-full flex flex-col">
              ...
              <div className="border-b p-6">
                <h2 className="text-2xl font-bold text-gray-900">Legal AI Assistant</h2>
                <p className="text-gray-600">Your AI assistant for Zimbabwe law questions</p>
              </div>
